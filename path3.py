...
def get_shortest_paths(entity_pairs: List[Tuple[int, int]], max_path_length: int = 2) -> Dict[str, List]:
    """
...
if __name__ == "__main__":
    ...
    found_nodes = [
        {"internal_id": 115, "canonical_name": "Самодержавие", "labels": ["Entity"]},
        {"internal_id": 269, "canonical_name": "Самодержавие", "labels": ["Entity"]}
    ]
